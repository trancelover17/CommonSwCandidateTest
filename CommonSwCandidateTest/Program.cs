...
namespace CommonSwCandidateTest
{
    ...
    public enum OutputType : byte { Console, CSVFile }
    ...
    public class CustomContainer
    {
        ...
        {
            var filepath = "C:\\dev\\hiararchical-Vyacheslav.csv"; // set path for file, just like in task
    ...
    class Program
    {
        static void Main()
        {
            ...
            myDict.DisplayHierarchicalTree(OutputType.Console); // call method for displaying hierarchical tree of elements
            ...
            myDict.DisplayHierarchicalTree(OutputType.CSVFile); // call method for creating data for writing to file
